...
public class OglasService {
    ...
    public List<Oglas> getOglasByPovrsinaMestoAndNaslov(int povrsina, String mesto, String naslov) {
        return oglasRepository.findByPovrsinaMestoAndNaslov(povrsina, mesto, naslov);
    }
}
